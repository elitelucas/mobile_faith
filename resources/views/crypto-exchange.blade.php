        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <p class="text-muted mb-2"><i class="mdi mdi-wallet mr-1"></i> Wallet Balance</p>
                        <h5>$ 9148.23</h5>
                    </div>
                            ...
                            <div class="tab-pane" id="exchange-tab" role="tabpanel">
                                <div class="float-right ml-2">
                                    <h5 class="font-size-14"><i
                                            class="bx bx-wallet text-primary font-size-16 align-middle mr-1"></i> $4235.23
                                    </h5>
                                </div>
