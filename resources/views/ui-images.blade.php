        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img class="rounded mr-2" alt="200x200" width="200" src="assets/images/small/img-4.jpg"
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="media-body">
                            ...
                            <div class="media mt-3">
                                <a class="d-flex pr-3" href="#">
                                    <img src="assets/images/users/avatar-3.jpg" alt="Generic placeholder image" height="64"
                    ...
                    <div class="media">
                        ...
                        <img class="d-flex ml-3 rounded-circle" src="assets/images/users/avatar-4.jpg"
                            alt="Generic placeholder image" height="64">
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media mb-4">
                        <img class="d-flex align-self-start rounded mr-3" src="assets/images/users/avatar-3.jpg"
                            alt="Generic placeholder image" height="64">
                        <div class="media-body">
                    ...
                    <div class="media mb-4">
                        <img class="d-flex align-self-center rounded mr-3" src="assets/images/users/avatar-5.jpg"
                            alt="Generic placeholder image" height="64">
                        <div class="media-body">
                    ...
                    <div class="media">
                        <img class="d-flex align-self-end rounded mr-3" src="assets/images/users/avatar-1.jpg"
                            alt="Generic placeholder image" height="64">
                        <div class="media-body">
