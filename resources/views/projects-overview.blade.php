...
@section('content')
    ...
    @component('common-components.breadcrumb')
        ...
        @slot('li_2') Project Overview @endslot
    @endcomponent
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-muted mt-4">
                        <p><i class="mdi mdi-chevron-right text-primary mr-1"></i> To achieve this, it would be necessary
                        </p>
                    ...
                    <div class="row task-dates">
                        ...
                        <div class="col-lg-4">
                            <div class="mt-4">
                                <h5 class="font-size-14"><i class="bx bx-calendar-check mr-1 text-primary"></i> Due Date
                                </h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered">
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="assets/images/users/avatar-1.jpg" class="rounded-circle avatar-xs" alt="">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt="">
                                    </td>
                                    <td>
