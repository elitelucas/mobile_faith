                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Re-Password with Faithspace.</p>
                                        </div>
                                    </div>
                                    <div class="col-5 align-self-end">
                                        <img src="assets/assets/images/logo.svg" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <form class="form-horizontal mt-4" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="email" type="email"
                                                class="form-control @error('email') is-invalid @enderror" value="{{ $email }}" id="username" placeholder="Enter Email"
