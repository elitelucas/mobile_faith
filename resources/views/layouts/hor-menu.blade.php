                ...
                <ul class="navbar-nav">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    ...
                                    <a href="form-layouts" class="dropdown-item">@lang('translation.Forms_Layouts')</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                            ...
                            <a href="layouts-boxed-horizontal" class="dropdown-item">@lang('translation.Boxed_Width')</a>
                            <a href="layouts-horizontal-preloader" class="dropdown-item">@lang('translation.Preloader')</a>
                            <a href="layouts-colored-topbar" class="dropdown-item">@lang('translation.Colored_Topbar')</a>
