                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-dashboard" role="button"
                            ...
                            <i class="bx bx-home-circle mr-2"></i>Admin Panel<div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                            <a href="/user" class="dropdown-item">Users</a></a>
                            <a href="/pray" class="dropdown-item">Prays</a></a>
                            <a href="/meditate?type=image" class="dropdown-item">Meditates(Image)</a></a>
                            <a href="/meditate?type=audio" class="dropdown-item">Meditates(Audio)</a></a>
                    ...
                    @if (1 == 0)
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="bx bx-customize mr-2"></i>@lang('translation.Apps') <div class="arrow-down">
                                </div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-crypto">
                                        ...
                                        <a href="crypto-buy-sell"
                                            class="dropdown-item">@lang('translation.Buy_Sell')</a>
                                        <a href="crypto-exchange"
                                            class="dropdown-item">@lang('translation.Exchange')</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-project">
                                        <a href="projects-grid"
                                            class="dropdown-item">@lang('translation.Projects_Grid')</a>
                                        <a href="projects-list"
                                            class="dropdown-item">@lang('translation.Projects_List')</a>
                                        <a href="projects-overview"
                                            class="dropdown-item">@lang('translation.Project_Overview')</a>
                                        <a href="projects-create"
                                            class="dropdown-item">@lang('translation.Create_New')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-task">
                                        ...
                                        <a href="tasks-kanban"
                                            class="dropdown-item">@lang('translation.Kanban_Board')</a>
                                        <a href="tasks-create"
                                            class="dropdown-item">@lang('translation.Create_Task')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-components">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-form">
                                        ...
                                        <a href="form-layouts"
                                            class="dropdown-item">@lang('translation.Forms_Layouts')</a>
                                        <a href="form-validation"
                                            class="dropdown-item">@lang('translation.Validation')</a>
                                        <a href="form-advanced" class="dropdown-item">@lang('translation.Advanced')</a>
                                        <a href="form-editors" class="dropdown-item">@lang('translation.Editors')</a>
                                        <a href="form-uploads"
                                            class="dropdown-item">@lang('translation.File_Upload')</a>
                                        <a href="form-xeditable"
                                            class="dropdown-item">@lang('translation.X_editable')</a>
                                        <a href="form-repeater"
                                            class="dropdown-item">@lang('translation.Form_Repeater')</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-table">
                                        <a href="tables-basic"
                                            class="dropdown-item">@lang('translation.Basic_Tables')</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                        <a href="charts-apex" class="dropdown-item">@lang('translation.Apexcharts')</a>
                                        <a href="charts-echart" class="dropdown-item">@lang('translation.ECharts')</a>
                                        ...
                                        <a href="charts-tui" class="dropdown-item">@lang('translation.Toast_UI')</a>
                                        <a href="charts-knob" class="dropdown-item">@lang('translation.Jquery')</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                        ...
                                        <a href="icons-dripicons"
                                            class="dropdown-item">@lang('translation.Dripicons')</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-map">
                                        ...
                                        <a href="maps-leaflet"
                                            class="dropdown-item">@lang('translation.Leaflet_Maps')</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="bx bx-layout mr-2"></i>@lang('translation.Layouts')<div class="arrow-down">
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                <a href="layouts-horizontal" class="dropdown-item">@lang('translation.Horizontal')</a>
                                <a href="layouts-vertical" class="dropdown-item">@lang('translation.Vertical')</a>
                                <a href="layouts-topbar-light"
                                    class="dropdown-item">@lang('translation.Topbar_Light')</a>
                                <a href="layouts-boxed-horizontal"
                                    class="dropdown-item">@lang('translation.Boxed_Width')</a>
                                <a href="layouts-horizontal-preloader"
                                    class="dropdown-item">@lang('translation.Preloader')</a>
                                <a href="layouts-colored-topbar"
                                    class="dropdown-item">@lang('translation.Colored_Topbar')</a>
                                <a href="layouts-scrollable-horizontal"
                                    class="dropdown-item">@lang('translation.Scrollable')</a>
                            </div>
                        </li>
                    @endif
