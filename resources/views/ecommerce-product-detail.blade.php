...
@section('content')
    ...
    @component('common-components.breadcrumb')
        ...
        @slot('li_2') Product Detail @endslot
    @endcomponent
                    ...
                    <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-3 col-4">
                                        <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist"
                                            ...
                                            <a class="nav-link active" id="product-1-tab" data-toggle="pill"
                                                href="#product-1" role="tab" aria-controls="product-1" aria-selected="true">
                                                <img src="assets/images/product/img-7.png" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </a>
                                            <a class="nav-link" id="product-2-tab" data-toggle="pill" href="#product-2"
                                                role="tab" aria-controls="product-2" aria-selected="false">
                                                <img src="assets/images/product/img-8.png" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </a>
                                            <a class="nav-link" id="product-3-tab" data-toggle="pill" href="#product-3"
                                                role="tab" aria-controls="product-3" aria-selected="false">
                                                <img src="assets/images/product/img-7.png" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </a>
                                            <a class="nav-link" id="product-4-tab" data-toggle="pill" href="#product-4"
                                                role="tab" aria-controls="product-4" aria-selected="false">
                                                <img src="assets/images/product/img-8.png" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </a>
                                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="mt-4 mt-xl-3">
                                ...
                                <h5 class="mb-4">Price : <span class="text-muted mr-2"><del>$240 USD</del></span> <b>$225
                                        USD</b></h5>
                        ...
                        <div class="media py-3 border-bottom">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media mt-4">
                                    <img src="assets/images/users/avatar-5.jpg" class="avatar-xs mr-3 rounded-circle"
                                        alt="img" />
                                    <div class="media-body">
                                        ...
                                        <div class="text-muted font-size-12"><i
                                                class="far fa-calendar-alt text-primary mr-1"></i> 08 Oct, 2019</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-left pt-3 pt-md-0">
                                            <h5 class="mb-3 text-truncate"><a href="#" class="text-dark">Wirless
                                                    Headphone</a></h5>
                                            <p class="text-muted">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-left pt-3 pt-md-0">
                                            <h5 class="mb-3 text-truncate"><a href="#" class="text-dark">Phone patterned
                                                    cases</a></h5>
                                            <p class="text-muted">
                                                <i class="bx bx-star text-warning"></i>
                                                <i class="bx bx-star text-warning"></i>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-left pt-3 pt-md-0">
                                            ...
                                            <h5 class="mb-3 text-truncate"><a href="#" class="text-dark">Phone Dark
